...
export class Chart implements OnInit {
    ...
    generateChart() {
        let el: any = jQuery(this.elementRef.nativeElement);
        if (el.find('.panel-body #morris-area-chart'))
            el.find('.panel-body #morris-area-chart').remove();
        el.find('.panel-body').append(`<div id='morris-area-chart' />`);
        if (window['morrisObj']) {
